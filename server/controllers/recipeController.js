...
//get categories
exports.explporeCategories = async (req, res) => {
    try {
        const limitNumber = 6;
        const categories = await Category.find({}).limit(limitNumber);
...
exports.explporeCategoriesById = async (req, res) => {
    try {
...
//explpore Latest
exports.explporeLatest = async (req, res) => {
    try {
        const limitNumber = 50;
...
// async function inserDymmyRecipeData() {
//     try {
//         await Recipe.insertMany([
//             {
//                 "author": "63426aab4cfd2f366ae7fb47",
